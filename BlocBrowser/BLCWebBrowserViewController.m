...
- (void)loadView {
    ...
    self.textField.placeholder = NSLocalizedString (@"Enter Website URL or Search", @"Placeholder text for web browser URL field");
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    if (!URL.scheme) {
        ...
        {
            URL = [NSURL URLWithString:[NSString stringWithFormat:@"http://google.com/search?q=%@", searchString]];
        }
        
        
   else    URL = [NSURL URLWithString:[NSString stringWithFormat:@"http://%@", URLString]];
    }
